...
const clients = [
  ...
  { name: 'Quattro Ristorante', logo: '/clients/quattroristorante.svg' },
  { name: 'Spice Klub', logo: '/clients/spice-klub.png' },
  { name: 'Mexicana Quattro', logo: '/clients/mexicana-quattro.svg' },
]
